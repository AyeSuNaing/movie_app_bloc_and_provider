              ...
              children: [
                Consumer<HomeBloc>(
                  builder: (context, bloc, child) => BannerSectionView(
                    bloc.mPopularMovieList.take(10).toList(),
                    (movieId) =>
                ...
                Consumer<HomeBloc>(
                  builder: (context, bloc, child) {
                    return GenreSectionView(
                      mGenreList: bloc.mGenreList,
                      mMoviesListByGenre: bloc.mMoviesByGenreList,
                      onTapMovie: (movieId) =>
                          _navigateToMovieDetailsScreen(context, movieId),
                      onTapGenre: (genreId) =>
